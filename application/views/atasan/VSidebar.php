        ...
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            ...
            <!-- <a class="" href="<?php echo base_url('pptk/CPPTK')?>"> -->
                ...
                <img src="<?php echo base_url('/assets/images/on.png') ?>" alt="" width="40">
                </div>
          ...
          <ul class="sidebar-menu">
              ...
              <li class="nav-item active"><a class="nav-link" href="<?php echo base_url('atasan/CAtasan')?>"><i class="fas fa-tasks"></i> <span>Sub Kegiatan</span></a></li>
              <li class="nav-item active"><a class="nav-link" href="<?php echo base_url('atasan/Chart')?>"><i class="fas fa-chart-line"></i> <span>Grafik</span></a></li>
        </aside>
      </div>
