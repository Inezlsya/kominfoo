        ...
        <?php echo $this->session->flashdata('message'); ?>
                ...
                <tr>
                    <td colspan="4">
                        ...
                        <?php echo form_open('bendahara/CBendahara/search',$attributes);?>
                            ...
                            <td>
                                <?php 
                                    if (empty($act->bukti_transfer1)) {
                                        ...
                                        echo '<center><img src="' . base_url('./uploads/bukti_transfer/' . $act->bukti_transfer1) . '" border="0" width="70px" height="70px"> </center>';
                                    }
                                ...
                                ?>
                                 <?php 
                                    if (empty($act->bukti_transfer2)) {
                                        ...
                                        echo '<center><img src="' . base_url('./uploads/bukti_transfer/' . $act->bukti_transfer2) . '" border="0" width="70px" height="70px"> </center>';
                                    }
                                ?>
                                <?php 
                                    if (empty($act->bukti_transfer3)) {
                                        ...
                                        echo '<center><img src="' . base_url('./uploads/bukti_transfer/' . $act->bukti_transfer3) . '" border="0" width="70px" height="70px"> </center>';
                                    }
                                ?>
                            </td>
...
<?php
                            ...
                            <td>
                            <?php echo anchor(
                                    'bendahara/CBendahara/halamanInput/' . $act->id_subkegiatan,
                                    '<div class="btn btn-primary btn-sm"><i class="fas fa-file-medical"></i></div>'
                                ) ?>
                            </td>
                            <td>
                            <?php echo anchor(
                                    'bendahara/CBendahara/halamanDetail/' . $act->id_subkegiatan,
...
<!-- Modal -->
<div class="modal fade" id="InputBuktiTransfer" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Input Bukti Transfer</h5>
