<div class="main-content">
    <section class="section">
        ...
        <buttton class="btn btn-primary mb-3" data-toggle="modal" data-target="#TambahKegiatan">
            <i class="fas fa-plus fa-sm"></i> Tambah Sub Kegiatan</buttton>
        <div>
                <tr>
                    <td colspan="4">
                        <?php $attributes = array('class' => 'row'); ?>
                        <?php echo form_open('operator/CSubKegiatanCRUD/search',$attributes);?>
            ...
            <table id="dataTables" class="table table-hover table-striped table-bordered">
                ...
                ?>
                    <tbody>
                        ...
                        <td>
                            <?php echo anchor(
                                'operator/CSubKegiatanCRUD/halamanDetail/' . $dxd->id_subkegiatan,
                        ...
                        <td>
                            <?php echo anchor(
                                'operator/CSubKegiatanCRUD/halamanUpdate/' . $dxd->id_subkegiatan,
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo base_url('operator/CSubKegiatanCRUD/fungsiTambah') ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                           <label for="name">Nama Kegiatan</label>
                            ...
                            <div class="form-group">
                           <label for="name">Nama Belanja</label>
                            <div class="form-group">
                               <select required name="nama_belanja"class="form-control">
                                ...
                                <?php                                
                                   foreach ($belanja as $dxd) {  
		                             ...
		                             echo "<option value='".$dxd->sub_belanja."'>".$dxd->sub_belanja."</option>";
		                                               }
		                                       echo"
		                                    </select>"
	                              	?>
                        ...
                        <div class="col-md-6">
                        <div class="form-group">
                           <label for="name">Pagu Anggaran</label>
                            <div class="form-group">
                               <select required name="pagu_anggaran"class="form-control">
        	                       
                                    <option value="">--Pilih Pagu Anggaran--</option>
                                <?php                                
                                   foreach ($belanja as $dxd) {  
                                       
		                             echo "<option value='".$dxd->jml_anggaran."'>".$dxd->jml_anggaran."</option>";
		                                               }
		                                       echo"
		                                    </select>"
	                              	?>
