<div class="main-content">
    <section class="section">
        ...
        <buttton class="btn btn-primary mb-3" data-toggle="modal" data-target="#TambahBelanja">
            <i class="fas fa-plus fa-sm"></i> Tambah Belanja</buttton>
        <div>
                <tr>
                    <td colspan="4">
                        <?php $attributes = array('class' => 'row'); ?>
                        <?php echo form_open('operator/CBelanjaCRUD/search',$attributes);?>
        ...
        <div class="table-responsive">
            <table id="dataTables" class="table table-hover table-striped table-bordered">
                ...
                <?php
                $no = 1;
                foreach ($belanja as $dxd) :
                ?>
                    <tbody>
                        <td><?php echo $no++ ?></td>
                        <td><?php echo $dxd->sub_belanja ?></td>
                        <td><?php echo $dxd->kode_rek ?></td>
                        <td><?php echo $dxd->jml_anggaran ?></td>
                        <td><?php echo $dxd->tanggal_input ?></td>

                        <td>
                            <?php echo anchor(
                                'operator/CBelanjaCRUD/halamanDetail/' . $dxd->id_belanja,
                        ...
                        <td>
                            <?php echo anchor(
                                'operator/CBelanjaCRUD/halamanUpdate/' . $dxd->id_belanja,
                        ...
                        <td>
                            ...
                            href="<?php echo base_url('operator/CBelanjaCRUD/fungsiDelete/') ?>/<?php echo $dxd->id_belanja ?>">
                            <i class="fa fa-trash"></i>
                        </a> -->

                            <a onclick="deleteConfirm('<?php echo site_url('operator/CBelanjaCRUD/fungsiDelete/' . $dxd->id_belanja) ?>')" href="#!" class="btn btn-sm btn-danger "><i class="fa fa-trash"></i></a>
                        </td>
                    </tbody>
                <?php endforeach; ?>
            </table>
...
<!-- Modal -->
<div class="modal fade" id="TambahBelanja" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo base_url('operator/CBelanjaCRUD/fungsiTambah') ?>" method="post" enctype="multipart/form-data">

                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Nama Belanja</label>
                                <input type="text" name="sub_belanja" class="form-control" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="jml_anggaran" class="form-control" required>
                            </div>
