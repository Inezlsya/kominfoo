      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="nav-item <?php echo $this->uri->segment(2) == 'CSubKegiatanCRUD' ? 'active' : '' ?>"><a class="nav-link" href="<?php echo base_url('operator/CSubKegiatanCRUD') ?>"><i class="fas fa-clipboard-list"></i> <span>Sub Kegiatan</span></a></li>
            <li class="nav-item <?php echo $this->uri->segment(2) == 'CBelanjaCRUD' ? 'active' : '' ?>"><a class="nav-link" href="<?php echo base_url('operator/CBelanjaCRUD') ?>"><i class="fas fa-clipboard-list"></i> <span>Belanja</span></a></li>
